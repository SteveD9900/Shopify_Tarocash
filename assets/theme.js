...
//       jQuery('.swatch[data-option-index="'+ i + '"] :radio[value="'+ variant.options[i] + '"]').
//     }
//   }
// }
...
$(".left_CM").click(function(){
  $(".IN_table").hide();
  $(".CM_table").show();
  $(".left_CM").removeClass("other_criteria");
  $(".left_CM").addClass("chose_criteria");
  $(".right_IN").addClass("other_criteria");
  $(".right_IN").removeClass("chose_criteria");
});

$(".right_IN").click(function(){
  $(".IN_table").show();
  $(".CM_table").hide();
  $(".right_IN").removeClass("other_criteria");
  $(".right_IN").addClass("chose_criteria");
  $(".left_CM").addClass("other_criteria");
  $(".left_CM").removeClass("chose_criteria");
});
// $(document).ready(function(){
